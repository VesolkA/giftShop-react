...
export const Hero = () => (
  ...
  <section className={style.hero}>
    <div className={classNames("container")}>
      ...
      <figure className={style['group-image']}>
        <picture className={classNames(style.image, style['image_left'])}>
          <source
        ...
        <svg className={classNames(style.image, style['image_center'])} role="img"
          ...
          <foreignObject clipPath="url(#hero)" width="100%" height="100%">
            <div className={style['image-center']}></div>
          </foreignObject>
        </svg>

        <picture className={classNames(style.image, style['image_right'])}>
          <source
